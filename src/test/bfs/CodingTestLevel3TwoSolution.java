...
public class CodingTestLevel3TwoSolution {
	...
	public static void main(String[] args) {
	 ...
	 private static int n;
	    ...
	    private static int bfs(Queue<Robot> queue, boolean[][][] visit) {
	    ...
	    private static boolean isValid(int x, int y) { // 맵 밖으로 나갔는지 체크
