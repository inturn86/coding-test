...
public class CodingTestTravelTargetSolution {
...
//	항공권 정보가 담긴 2차원 배열 tickets가 매개변수로 주어질 때, 방문하는 공항 경로를 배열에 담아 return 하도록 solution 함수를 작성해주세요.
	...
	public static void dfs(boolean[] visited, Stack<String> st, int len, String[][] tickets) {
		...
		for (int i = 0; i < tickets.length; i++) {
			...
			if (!visited[i] && arrive.equals(tic[0])) {
				...
				System.out.println("tic[1]  = " + tic[1]);
				st.push(tic[1]);
				visited[i] = true;

				System.out.println("int st  = " + st);
